...
class AssignedDonation extends StatefulWidget {
  //DonartionHistory(this.donations);
  final volunteerId;
  AssignedDonation(this.volunteerId);
  @override
  _DonartionHistoryState createState() => _DonartionHistoryState();
}

class _DonartionHistoryState extends State<AssignedDonation> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<List<Donations>> fetchDonations() async {
    String url =
        'https://edonations.000webhostapp.com/api-assigned-donation.php';
    var data = {
